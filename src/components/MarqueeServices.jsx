...
import { Truck, Anchor, ShieldCheck, FileCheck2, Box, Warehouse, Globe2, Scale, ArrowRight, X, ChevronLeft, ChevronRight, Send, CheckCircle, Plus, Edit2, Trash2 } from 'lucide-react';
...
export default function MarqueeServices({ adminToken }) {
  ...
  return (
    <section className="relative z-10 bg-transparent pt-16 pb-14 border-t border-slate-900/80 overflow-hidden" id="servicios">
      ...
      {/* TÍTULO Y CABECERA CON BOTÓN DE ADMIN */}
      ...
      <div className="max-w-4xl mx-auto px-6 mb-8">
        <div className="flex flex-wrap items-center justify-center gap-2.5 bg-slate-900/70 p-2 rounded-2xl border border-slate-800/80 backdrop-blur-xl shadow-xl">
          {[
      ...
      {/* MINI-HERO DEL SERVICIO */}
      <div
        className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 relative"
